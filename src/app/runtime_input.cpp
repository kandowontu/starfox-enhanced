...
#else
    add_gamepad_button(result, gamepad, SDL_GAMEPAD_BUTTON_EAST, setup_confirm?input::b:input::a);
    add_gamepad_button(result, gamepad, SDL_GAMEPAD_BUTTON_WEST, input::y);
    add_gamepad_button(result, gamepad, SDL_GAMEPAD_BUTTON_SOUTH, setup_confirm?input::a:input::b);
#endif
